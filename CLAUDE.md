...
The HeyGen Skill Stack. Two skills that chain together: **avatar-designer** (identity → avatar → voice) and **video-producer** (idea → script → video). SKILL.md at root routes between them.
